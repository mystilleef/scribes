...
def open_database(flag="c"):
	...
	database_file = join(preference_folder, "Encoding.gdb")
...
def get_value():
	"""
	Get encoding options in database.
...
def set_value(encoding_list):
	"""
	Set encoding options in database.

	@param encoding_list: A list of encodings.
	@type encoding_list: A List object.
	"""
	try:
