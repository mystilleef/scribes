...
CYGPATH_W = echo
DATADIRNAME = share
DEFS = -DPACKAGE_NAME=\"scribes\" -DPACKAGE_TARNAME=\"scribes\" -DPACKAGE_VERSION=\"0.3.2.10-save-rev1\" -DPACKAGE_STRING=\"scribes\ 0.3.2.10-save-rev1\" -DPACKAGE_BUGREPORT=\"\<mystilleef@gmail.com\>\" -DPACKAGE=\"scribes\" -DVERSION=\"0.3.2.10-save-rev1\" -DGETTEXT_PACKAGE=\"scribes\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_LOCALE_H=1 -DHAVE_LC_MESSAGES=1 -DHAVE_BIND_TEXTDOMAIN_CODESET=1 -DHAVE_GETTEXT=1 -DHAVE_DCGETTEXT=1 -DENABLE_NLS=1
DEPDIR = .deps
DOC_USER_FORMATS = 
ECHO_C = 
ECHO_N = -n
...
PACKAGE_STRING = scribes 0.3.2.10-save-rev1
PACKAGE_TARNAME = scribes
PACKAGE_VERSION = 0.3.2.10-save-rev1
PATH_SEPARATOR = :
