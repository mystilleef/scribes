class Window(object):
	...
	def __init__(self, manager, editor):
		...
		self.__sigid2 = manager.connect("show-export-window", self.__show_cb)
		self.__sigid3 = manager.connect("hide-export-window", self.__hide_cb)
	...
	def __init_attributes(self, manager, editor):
		...
		self.__window = manager.export_gui.get_widget("Window")
		return
