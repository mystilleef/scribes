class Button(object):
	...
	def __init__(self, manager, editor):
		...
		self.__sigid2 = manager.connect("can-import-selected-file", self.__valid_cb)
		self.__sigid3 = self.__button.connect("clicked", self.__clicked_cb)

	def __init_attributes(self, manager, editor):
		self.__manager = manager
		self.__editor = editor
		self.__button = manager.import_gui.get_widget("ImportButton")
		return
	...
	def __clicked_cb(self, *args):
		self.__manager.emit("import-button-clicked")
		return False
