...
""" 
This module documents functions to store and get tab width
properties from the tab width database.
...
def open_database(flag="c"):
	"""
	Open the tab width database.

	@return: A database object representing the tab width database.
...
def set_value(value):
	"""
	Set font property in database.

	@param value: Font property
