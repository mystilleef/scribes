...
class SaveFilePlugin(object):
	...
	def __init__(self, editor):
		...
		@param self: Reference to the SaveFilePlugin instance.
		@type self: A SaveFilePlugin object.
	...
	def load(self):
		"""
		Initialize the SaveFilePlugin instance.

		@param self: Reference to the SaveFilePlugin instance.
		@type self: An SaveFilePlugin object.
		"""
		from SaveFile.Trigger import SaveFileTrigger
		self.__trigger = SaveFileTrigger(self.__editor)
		return

	def unload(self):
		"""
		Destroy the SaveFilePlugin instance.
