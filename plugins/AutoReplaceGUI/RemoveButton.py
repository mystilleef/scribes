...
class AutoReplaceRemoveButton(Button):
	"""
	This class creates a button used to remove words for automatic
	replacement to the automatic replacement dialog.
	"""
	...
	def __init__(self, manager, editor):
		...
		@param self: Reference to the AutoReplaceRemoveButton instance.
		@type self: An AutoReplaceRemoveButton object.
		...
		"""
		from gtk import STOCK_REMOVE
		Button.__init__(self, stock=STOCK_REMOVE, use_underline=True)
