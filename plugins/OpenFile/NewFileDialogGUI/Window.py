...
class Window(object):
	"""
	This class creates the window for new file dialog window.
	"""
	...
	def __init__(self, editor, manager):
		...
		self.__sigid2 = self.__manager.connect("show-newfile-dialog-window", self.__show_window_cb)
		self.__sigid3 = self.__manager.connect("hide-newfile-dialog-window", self.__hide_window_cb)
	...
	def __init_attributes(self, editor, manager):
		...
		self.__window = manager.new_gui.get_widget("Window")
		return
	...
	def __show(self):
		...
		self.__editor.busy()
		self.__editor.set_message(_("New Document"), "new")
		return False

	def __hide(self):
		self.__editor.busy(False)
		self.__editor.unset_message(_("New Document"), "new")
		self.__window.hide()
		return False
