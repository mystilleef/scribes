...
"""
This module documents a class that creates a trigger to save a file.
...
class SaveFileTrigger(GObject):
	"""
	This class creates an object, a trigger, that allows users to save
	a file.
	"""
	...
	def __init__(self, editor):
		...
		@param self: Reference to the SaveFileTrigger instance.
		...
		self.__signal_id_1 = self.__trigger.connect("activate", self.__save_file_cb)
	...
	def __destroy_cb(self, trigger):
		...
		@param self: Reference to the SaveFileTrigger instance.
		@type self: An SaveFileTrigger object.
