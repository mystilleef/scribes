...
class LexicalScopeHighlightPlugin(object):
	"""
	...
	def __init__(self, editor):
		...
		@param self: Reference to the LexicalScopeHighlightPlugin instance.
		@type self: A LexicalScopeHighlightPlugin object.
	...
	def load(self):
		"""
		Initialize the LexicalScopeHighlightPlugin instance.

		@param self: Reference to the LexicalScopeHighlightPlugin instance.
		@type self: An LexicalScopeHighlightPlugin object.
		"""
		from LexicalScopeHighlight.Highlight import Highlighter
		self.__highlighter = Highlighter(self.__editor)
		return

	def unload(self):
		"""
		Destroy the LexicalScopeHighlightPlugin instance.
