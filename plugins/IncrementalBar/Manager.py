...
class IncrementalBar(ScribesBar):
	"""
...
########################################################################
	...
	def __set_properties(self):
		...
		self.set_property("name", "scribes incremental findbar")
	...
	def __findbar_show_bar_cb(self, editor, bar):
		...
		self.__status_id_1 = self.__editor.feedback.set_modal_message(msg0008, "find")
		return
	...
	def __findbar_hide_bar_cb(self, editor, bar):
		...
		self.__editor.feedback.update_status_message(msg0009, "info")
