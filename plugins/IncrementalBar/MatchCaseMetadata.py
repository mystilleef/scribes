...
to enable or disable case matching during searches.
...
def open_database(flag="c"):
	...
	database_file = join(preference_folder, "MatchCase.gdb")
...
def get_value():
	"""
	Get match case value from database.

	@return: True/False to enable/disable case matching.
...
def set_value(match_case):
	"""
	Set match case value in database.

	@param match_case: True/False to enable/disable case matching.
