class Button(object):
	...
	def __init_attributes(self, manager, editor):
		...
		self.__button = manager.gui.get_object("SpacesCheckButton")
	...
	def __update(self, language=""):
		...
		use_tabs = get_value(self.__language)
	...
	def __set(self):
		...
		from SCRIBES.UseTabsMetadata import set_value
		set_value((self.__language, not use_spaces))
		return False

	def __reset(self):
		from SCRIBES.UseTabsMetadata import reset
