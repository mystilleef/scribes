...
"""
This module documents a class that implements the save button for the
file chooser
...
class Button(object):
	"""
	This class defines the properties and behavior of the save button on
	the file chooser.
	"""
	...
	def __init_attributes(self, editor, manager):
		...
		self.__button = manager.glade.get_widget("SaveButton")
		return
	...
	def __error_cb(self, manager, value):
		"""
		Handles callback when the "error" signal is emitted.
