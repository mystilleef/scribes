...
class CasePlugin(object):
	...
	def __init__(self, editor):
		...
		@param self: Reference to the CasePlugin instance.
		@type self: A CasePlugin object.
	...
	def load(self):
		"""
		Initialize the CasePlugin instance.

		@param self: Reference to the CasePlugin instance.
		@type self: An CasePlugin object.
		"""
		from Case.Trigger import CaseTrigger
		self.__trigger = CaseTrigger(self.__editor)
		return

	def unload(self):
		"""
		Destroy the CasePlugin instance.
